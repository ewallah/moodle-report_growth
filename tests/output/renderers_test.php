...
class renderers_test extends advanced_testcase {
    ...
    public function test_course() {
        ...
        $this->assertStringContainsString('Show chart data', $output->create_tabtree($context, 1));
        // TODO: Search for 4 enrolled users.
    ...
    public function test_global() {
        ...
        $this->assertStringContainsString('>4</td>', $output->table_users());
        $this->assertStringContainsString('>4</td>', $output->table_courses());
